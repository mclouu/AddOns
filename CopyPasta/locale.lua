...
La["Bind a key to toggle the Paste window"] = "붙여넣기 창을 활성화하기 위한 키를 지정하십시오"
La["characters"] = "글자"
La["Clear"] = "초기화"
--[[Translation missing --]]
--[[ La["Command-V"] = ""--]] 
...
La["Control-V"] = "Ctrl-V"
La["Debug"] = "디버그"
La["Display minimap icon"] = "미니맵에 아이콘 표시"
La["Edit font scale"] = "폰트 사이즈 설정"
--[[Translation missing --]]
--[[ La["for options"] = ""--]] 
La["General"] = "일반"
La["It looks like you're pasting some slash commands to a chat channel. Would you like to execute them instead?"] = "당신은 ' / ' 명령어를 채팅창에 치는 것 같습니다. 명령어를 출력하지 않고 실행하겠습니까?"
La["Left Click"] = "좌클릭"
La["lines"] = "줄"
La["Minimap Icon"] = "미니맵 아이콘"
La["Open the configuration GUI"] = "설정 창 열기"
La["Paste"] = "붙여넣기"
La["Paste and Close"] = "붙여넣고 창 닫기"
La["Paste to:"] = "붙여넣을 위치 :"
La["Profiles"] = "프로필"
La["Right Click"] = "우클릭"
La["Scale the Paste window and all its contents"] = "붙여넣기 창과 내용물들의 크기를 설정합니다"
La["Scale the text font used in the Paste edit box"] = "붙여넣기 내용 편집창의 글자 크기 설정"
La["Shift-Enter hotkey while typing in the edit box will Paste and Close"] = "편집중 Shift-Enter 키를 누르면 붙여넣고 창을 닫습니다"
La["Shift-Enter to Paste"] = "Shift-Enter 키로 붙여넣기"
La["Show"] = "보이기"
La["Show/Hide the Paste window"] = "붙여넣기 창 보이기/숨기기"
La["Strip Empty Lines"] = "비어있는 줄 무시"
La["Strip empty lines (those containing only whitespace) from the output. Note some channels automatically drop fully empty lines."] = "출력할때 빈 줄을 무시합니다. 체크하지 않아도 일부 채널은 자동적으로 빈 줄을 무시할수도 있습니다."
--[[Translation missing --]]
--[[ La["to toggle window"] = ""--]] 
--[[Translation missing --]]
...
La["Use %s to paste the clipboard into this box"] = "%s 를 사용하면 클립보드 내용을 이 창에 붙여넣을 수 있습니다"
La["Window Scale"] = "창 크기"
La["You must select a whisper target!"] = "귓속말 대상을 선택해야 합니다!"
...
La["Strip empty lines (those containing only whitespace) from the output. Note some channels automatically drop fully empty lines."] = "Juntar lineas en blanco (aquellas que contienen solo espacios en blanco) de la salida. Algunos canales, eliminan completamente esas lineas"
...
La["Control-V"] = "Ctrl-V"
La["Debug"] = "Depurar"
La["Display minimap icon"] = "Mostrar icono en el mini mapa"
La["Edit font scale"] = "Editar tamaño de fuente"
La["for options"] = "para opciones"
La["General"] = "General"
La["It looks like you're pasting some slash commands to a chat channel. Would you like to execute them instead?"] = "Parece que estás pegando comandos en un canal de chat. ¿Quieres ejecutarlos?"
La["Left Click"] = "Clic izquierdo"
La["lines"] = "líneas"
La["Minimap Icon"] = "Icono en mini mapa"
La["Open the configuration GUI"] = "Mostrar ventana de configuración"
La["Paste"] = "Pegar"
La["Paste and Close"] = "Pegar y Cerrar"
La["Paste to:"] = "Pegar en:"
La["Profiles"] = "Perfiles"
La["Right Click"] = "Clic derecho"
La["Scale the Paste window and all its contents"] = "Cambia el tamaño de la ventana de Paste y su contenido"
La["Scale the text font used in the Paste edit box"] = "Cambia el tamaño de la fuente en el editor de Paste"
La["Shift-Enter hotkey while typing in the edit box will Paste and Close"] = "Pulsar Mayúsculas-Intro en el editor de Paste para Pegar y Cerrar"
La["Shift-Enter to Paste"] = "Mayúsculas-Intro para pegar"
La["Show"] = "Mostrar"
La["Show/Hide the Paste window"] = "Mostrar/ocultar la ventana de Paste"
La["Strip Empty Lines"] = "Borrar líneas vacías"
La["Strip empty lines (those containing only whitespace) from the output. Note some channels automatically drop fully empty lines."] = "Borra las líneas vacías (las que sólo incluyan espacios) al enviar. Ten en cuenta que algunos canales borran las líneas vacías de por sí."
La["to toggle window"] = "para mostrar/ocultar la ventana"
La["Toggle debugging output"] = "Activar/Desactivar mensajes de depuración"
La["Trim Whitespace"] = "Reducir espacios"
La["Trim whitespace from the beginning and end of lines in the output."] = "Borra espacios adicionales al principio y al final de cada línea."
La["Use %s to paste the clipboard into this box"] = "Usa %s para pegar el contenido del porta papeles en esta casilla"
...
La["Open the configuration GUI"] = "Abrir as configurações de interface gráfico"
La["Paste"] = "Colar"
...
La["Shift-Enter to Paste"] = "Shift-Enter para abrir o Paste"
La["Show"] = "Mostar"
La["Show/Hide the Paste window"] = "Mostar/Esconder a janela do Paste"
La["Strip Empty Lines"] = "Remover linhas vazias"
La["Strip empty lines (those containing only whitespace) from the output. Note some channels automatically drop fully empty lines."] = "Remover linhas vazias (apenas espaços em branco) a partir do texto que está a escrever. Observe que alguns canais retiram automaticamente linhas totalmente vazias."
...
La["Window Scale"] = "Dimensão da janela"
La["You must select a whisper target!"] = "Deve escolher a quem pretender sussurrar!"

elseif locale == "itIT" then do end
La["Bind a key to toggle the Paste window"] = "Collega un tasto per attivare la finestra di Paste"
...
La["Control-V"] = "Control-V"
La["Debug"] = "Debug"
La["Display minimap icon"] = "Mostra l'icona della mini mappa"
La["Edit font scale"] = "Modifica dimensione font"
La["for options"] = "per le opzioni"
La["General"] = "Generale"
La["It looks like you're pasting some slash commands to a chat channel. Would you like to execute them instead?"] = "Pare che tu stia incollando dei comandi slash nel canale di chat. Vuoi che vengano eseguiti invece?"
La["Left Click"] = "Click sinistro"
La["lines"] = "righe"
La["Minimap Icon"] = "Icona della mini mappa"
La["Open the configuration GUI"] = "Apri l'interfaccia di configurazione"
La["Paste"] = "Incolla"
La["Paste and Close"] = "Incolla e Chiudi"
La["Paste to:"] = "Incolla su:"
La["Profiles"] = "Profili"
La["Right Click"] = "Click Destro"
La["Scale the Paste window and all its contents"] = "Ridimensiona la finestra di Paste ed il suo contenuto"
La["Scale the text font used in the Paste edit box"] = "Ridimensiona il testo usato nella casella di Paste"
La["Shift-Enter hotkey while typing in the edit box will Paste and Close"] = "Maiuscolo-Invio durante la scrittura fara' Incolla e Chiudi"
La["Shift-Enter to Paste"] = "Maiuscolo-Invio per Incollare"
La["Show"] = "Mostra"
La["Show/Hide the Paste window"] = "Mostra/Nascondi la finestra di Paste"
La["Strip Empty Lines"] = "Togli righe vuote"
La["Strip empty lines (those containing only whitespace) from the output. Note some channels automatically drop fully empty lines."] = "Togli righe vuote (contenenti solo spazi bianchi) dal risultato. Nota che alcuni canali rimuovono automaticamente le linee completamente vuote"
La["to toggle window"] = "per attivare la finestra"
La["Toggle debugging output"] = "Attiva i messaggi di debug"
La["Trim Whitespace"] = "Pulisci spazi bianchi"
La["Trim whitespace from the beginning and end of lines in the output."] = "Pulisci spazi bianchi dall'inizio alla fine delle linee in uscita"
La["Use %s to paste the clipboard into this box"] = "Usa %s per incollare gli appunti in questo riquadro"
La["Window Scale"] = "Dimensione Finestra"
La["You must select a whisper target!"] = "Devi scegliere qualcuno a cui sussurrare!"
